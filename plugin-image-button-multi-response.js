var jsPsychImageButtonMultiResponse = (function (jspsych) {
  'use strict';

  var version = "0.0.1";

  const info = {
    name: "image-button-multi-response",
    version,
    parameters: {
  ...
  class ImageButtonMultiResponsePlugin {
    constructor(jsPsych) {
  ...
  return ImageButtonMultiResponsePlugin;
